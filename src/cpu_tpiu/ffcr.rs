...
impl R {
    ...
    #[doc = "Bit 8 - 8:8\\] Indicates that triggers are inserted when a trigger pin is asserted."]
    #[inline]
    ...
    #[doc = "Bit 1 - 1:1\\] Enable continuous formatting: 0: Continuous formatting disabled 1: Continuous formatting enabled"]
    #[inline]
