...
#[doc = r" Proxy"]
pub struct _FTNONSTOPW<'a> {
    w: &'a mut W,
}
impl<'a> _FTNONSTOPW<'a> {
...
impl R {
    ...
    #[doc = "Bit 3 - 3:3\\] 0: Formatter can be stopped 1: Formatter cannot be stopped"]
    #[inline]
    ...
    #[doc = "Bits 0:2 - 2:0\\] This field always reads as zero"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 3 - 3:3\\] 0: Formatter can be stopped 1: Formatter cannot be stopped"]
    #[inline]
    pub fn ftnonstop(&mut self) -> _FTNONSTOPW {
        _FTNONSTOPW { w: self }
    }
    #[doc = "Bits 0:2 - 2:0\\] This field always reads as zero"]
    #[inline]
