...
impl R {
    ...
    #[doc = "Bit 24 - 24:24\\] Sets the state of the pin that is configured as DIO#23, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    ...
    #[doc = "Bit 16 - 16:16\\] Sets the state of the pin that is configured as DIO#22, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    ...
    #[doc = "Bit 8 - 8:8\\] Sets the state of the pin that is configured as DIO#21, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] Sets the state of the pin that is configured as DIO#20, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
