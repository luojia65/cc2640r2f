...
impl R {
    ...
    #[doc = "Bit 24 - 24:24\\] Sets the state of the pin that is configured as DIO#7, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    ...
    #[doc = "Bit 16 - 16:16\\] Sets the state of the pin that is configured as DIO#6, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    ...
    #[doc = "Bit 8 - 8:8\\] Sets the state of the pin that is configured as DIO#5, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] Sets the state of the pin that is configured as DIO#4, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
