...
impl R {
    ...
    #[doc = "Bit 24 - 24:24\\] Sets the state of the pin that is configured as DIO#15, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    ...
    #[doc = "Bit 16 - 16:16\\] Sets the state of the pin that is configured as DIO#14, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    ...
    #[doc = "Bit 8 - 8:8\\] Sets the state of the pin that is configured as DIO#13, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] Sets the state of the pin that is configured as DIO#12, if the corresponding DOE31_0 bitfield is set."]
    #[inline]
