...
impl R {
    ...
    #[doc = "Bit 1 - 1:1\\] 1: Allow IRQFLAGSTAT.SHUTDOWN_OVF to activate the interrupt from this module."]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] 1: Allow IRQFLAGSTAT.RDY to activate the interrupt from this module."]
    #[inline]
