...
impl R {
    ...
    #[doc = "Bit 29 - 29:29\\] Enable 32 kHz clock to AUX_COMPB."]
    #[inline]
    ...
    #[doc = "Bits 0:28 - 28:0\\] Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
