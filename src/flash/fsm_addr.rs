...
impl R {
    ...
    #[doc = "Bits 28:30 - 30:28\\] Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 0:27 - 27:0\\] Internal. Only to be used through TI provided API."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 0:27 - 27:0\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn cur_addr(&mut self) -> _CUR_ADDRW {
        _CUR_ADDRW { w: self }
    }
}
