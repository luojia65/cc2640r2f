...
#[doc = r" Proxy"]
pub struct _FSM_ERR_ADDRW<'a> {
    w: &'a mut W,
}
impl<'a> _FSM_ERR_ADDRW<'a> {
...
#[doc = r" Proxy"]
pub struct _FSM_ERR_BANKW<'a> {
    w: &'a mut W,
}
impl<'a> _FSM_ERR_BANKW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 15;
...
impl R {
    ...
    #[doc = "Bits 8:31 - 31:8\\] Internal. Only to be used through TI provided API."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 8:31 - 31:8\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn fsm_err_addr(&mut self) -> _FSM_ERR_ADDRW {
        _FSM_ERR_ADDRW { w: self }
    }
    #[doc = "Bits 4:7 - 7:4\\] Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bits 0:3 - 3:0\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn fsm_err_bank(&mut self) -> _FSM_ERR_BANKW {
        _FSM_ERR_BANKW { w: self }
    }
}
