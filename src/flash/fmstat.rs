...
impl W {
    ...
    #[doc = "Bit 17 - 17:17\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn rvsusp(&mut self) -> _RVSUSPW {
        _RVSUSPW { w: self }
    }
    #[doc = "Bit 16 - 16:16\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn rdver(&mut self) -> _RDVERW {
        _RDVERW { w: self }
    }
    #[doc = "Bit 15 - 15:15\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn rvf(&mut self) -> _RVFW {
        _RVFW { w: self }
    }
    #[doc = "Bit 14 - 14:14\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn ila(&mut self) -> _ILAW {
        _ILAW { w: self }
    }
    #[doc = "Bit 13 - 13:13\\] Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bit 12 - 12:12\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn pgv(&mut self) -> _PGVW {
        _PGVW { w: self }
    }
    #[doc = "Bit 11 - 11:11\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn pcv(&mut self) -> _PCVW {
        _PCVW { w: self }
    }
    #[doc = "Bit 10 - 10:10\\] Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bit 5 - 5:5\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn invdat(&mut self) -> _INVDATW {
        _INVDATW { w: self }
    }
    #[doc = "Bit 4 - 4:4\\] Internal. Only to be used through TI provided API."]
    #[inline]
    ...
    #[doc = "Bit 3 - 3:3\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn volstat(&mut self) -> _VOLSTATW {
        _VOLSTATW { w: self }
    }
    #[doc = "Bit 2 - 2:2\\] Internal. Only to be used through TI provided API."]
    #[inline]
