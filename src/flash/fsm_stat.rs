...
#[doc = r" Proxy"]
pub struct _OVR_PUL_CNTW<'a> {
    w: &'a mut W,
}
impl<'a> _OVR_PUL_CNTW<'a> {
    #[doc = r" Sets the field bit"]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
    }
...
impl W {
    ...
    #[doc = "Bit 2 - 2:2\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn non_op(&mut self) -> _NON_OPW {
        _NON_OPW { w: self }
    }
    #[doc = "Bit 1 - 1:1\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn ovr_pul_cnt(&mut self) -> _OVR_PUL_CNTW {
        _OVR_PUL_CNTW { w: self }
    }
    #[doc = "Bit 0 - 0:0\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn inv_dat(&mut self) -> _INV_DATW {
        _INV_DATW { w: self }
    }
}
