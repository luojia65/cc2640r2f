...
#[doc = r" Proxy"]
pub struct _B1_MAX_SECTORW<'a> {
    w: &'a mut W,
}
impl<'a> _B1_MAX_SECTORW<'a> {
...
#[doc = r" Proxy"]
pub struct _B1_MUX_FACTORW<'a> {
    w: &'a mut W,
}
impl<'a> _B1_MUX_FACTORW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 15;
...
#[doc = r" Proxy"]
pub struct _B1_START_ADDRW<'a> {
    w: &'a mut W,
}
impl<'a> _B1_START_ADDRW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 28:31 - 31:28\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn b1_max_sector(&mut self) -> _B1_MAX_SECTORW {
        _B1_MAX_SECTORW { w: self }
    }
    #[doc = "Bits 24:27 - 27:24\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn b1_mux_factor(&mut self) -> _B1_MUX_FACTORW {
        _B1_MUX_FACTORW { w: self }
    }
    #[doc = "Bits 0:23 - 23:0\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn b1_start_addr(&mut self) -> _B1_START_ADDRW {
        _B1_START_ADDRW { w: self }
    }
}
