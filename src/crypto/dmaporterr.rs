...
impl R {
    ...
    #[doc = "Bit 12 - 12:12\\] A 1 indicates that the Crypto peripheral has detected an AHB bus error"]
    #[inline]
    ...
    #[doc = "Bit 9 - 9:9\\] Indicates which channel was serviced last (channel 0 or channel 1) by the AHB master port."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 12 - 12:12\\] A 1 indicates that the Crypto peripheral has detected an AHB bus error"]
    #[inline]
    pub fn ahb_err(&mut self) -> _AHB_ERRW {
        _AHB_ERRW { w: self }
    }
    #[doc = "Bits 10:11 - 11:10\\] Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
    ...
    #[doc = "Bit 9 - 9:9\\] Indicates which channel was serviced last (channel 0 or channel 1) by the AHB master port."]
    #[inline]
    pub fn last_ch(&mut self) -> _LAST_CHW {
        _LAST_CHW { w: self }
    }
    #[doc = "Bits 0:8 - 8:0\\] Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
