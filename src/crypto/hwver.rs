...
impl R {
    ...
    #[doc = "Bits 8:15 - 15:8\\] These bits simply contain the complement of VER_NUM (0x87), used by a driver to ascertain that the Crypto peripheral register is indeed read."]
    #[inline]
    ...
    #[doc = "Bits 0:7 - 7:0\\] The version number for the Crypto peripheral, this field contains the value 120 (decimal) or 0x78."]
    #[inline]
