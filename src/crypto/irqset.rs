...
impl R {
    ...
    #[doc = "Bit 1 - 1:1\\] If 1 is written to this bit, IRQSTAT.DMA_IN_DONE is set. Writing 0 has no effect."]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] If 1 is written to this bit, IRQSTAT.RESULT_AVAIL is set. Writing 0 has no effect."]
    #[inline]
