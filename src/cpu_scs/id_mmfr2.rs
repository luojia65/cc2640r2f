...
#[doc = r" Proxy"]
pub struct _WAIT_FOR_INTERRUPT_STALLINGW<'a> {
    w: &'a mut W,
}
impl<'a> _WAIT_FOR_INTERRUPT_STALLINGW<'a> {
...
impl R {
    ...
    #[doc = "Bit 24 - 24:24\\] wait for interrupt stalling 0x0: Not supported 0x1: Wait for interrupt supported"]
    #[inline]
...
impl W {
    ...
    #[doc = "Bit 24 - 24:24\\] wait for interrupt stalling 0x0: Not supported 0x1: Wait for interrupt supported"]
    #[inline]
    pub fn wait_for_interrupt_stalling(&mut self) -> _WAIT_FOR_INTERRUPT_STALLINGW {
        _WAIT_FOR_INTERRUPT_STALLINGW { w: self }
    }
    #[doc = "Bits 0:23 - 23:0\\] Software should not rely on the value of a reserved. Writing any other value than the reset value may result in undefined behavior."]
    #[inline]
