...
impl R {
    ...
    #[doc = "Bit 3 - 3:3\\] Clear vector flag 3. 0: No effect. 1: Clear VECFLAGS.VEC3. Read value is 0."]
    #[inline]
    ...
    #[doc = "Bit 2 - 2:2\\] Clear vector flag 2. 0: No effect. 1: Clear VECFLAGS.VEC2. Read value is 0."]
    #[inline]
    ...
    #[doc = "Bit 1 - 1:1\\] Clear vector flag 1. 0: No effect. 1: Clear VECFLAGS.VEC1. Read value is 0."]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] Clear vector flag 0. 0: No effect. 1: Clear VECFLAGS.VEC0. Read value is 0."]
    #[inline]
