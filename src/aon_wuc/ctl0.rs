...
#[doc = r" Value of the field"]
pub struct AUX_SRAM_ERASER {
    bits: bool,
}
impl AUX_SRAM_ERASER {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
#[doc = r" Value of the field"]
pub struct MCU_SRAM_ERASER {
    bits: bool,
}
impl MCU_SRAM_ERASER {
    #[doc = r" Value of the field as raw bits"]
    #[inline]
    pub fn bit(&self) -> bool {
        self.bits
...
impl R {
    ...
    #[doc = "Bit 8 - 8:8\\] Controls whether MCU and AUX requesting to be powered off will enable a transition to powerdown: 0: Enabled 1: Disabled"]
    #[inline]
    ...
    #[inline]
    pub fn aux_sram_erase(&self) -> AUX_SRAM_ERASER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 3;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        AUX_SRAM_ERASER { bits }
    }
    #[doc = "Bit 2 - 2:2\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn mcu_sram_erase(&self) -> MCU_SRAM_ERASER {
        let bits = {
            const MASK: bool = true;
            const OFFSET: u8 = 2;
            ((self.bits >> OFFSET) & MASK as u32) != 0
        };
        MCU_SRAM_ERASER { bits }
    }
