...
#[doc = r" Proxy"]
pub struct _VHV_E_STARTW<'a> {
    w: &'a mut W,
}
impl<'a> _VHV_E_STARTW<'a> {
...
#[doc = r" Proxy"]
pub struct _VHV_E_STEP_HIGHTW<'a> {
    w: &'a mut W,
}
impl<'a> _VHV_E_STEP_HIGHTW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
        const MASK: u16 = 65535;
...
impl W {
    ...
    #[doc = "Bits 16:31 - 31:16\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn vhv_e_start(&mut self) -> _VHV_E_STARTW {
        _VHV_E_STARTW { w: self }
    }
    #[doc = "Bits 0:15 - 15:0\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn vhv_e_step_hight(&mut self) -> _VHV_E_STEP_HIGHTW {
        _VHV_E_STEP_HIGHTW { w: self }
    }
}
