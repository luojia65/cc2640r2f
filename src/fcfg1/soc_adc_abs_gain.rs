...
#[doc = r" Proxy"]
pub struct _SOC_ADC_ABS_GAIN_TEMP1W<'a> {
    w: &'a mut W,
}
impl<'a> _SOC_ADC_ABS_GAIN_TEMP1W<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
        const MASK: u16 = 65535;
...
impl R {
    ...
    #[doc = "Bits 0:15 - 15:0\\] SOC_ADC gain in absolute reference mode at temperature 1 (30C). Calculated in production test.."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 0:15 - 15:0\\] SOC_ADC gain in absolute reference mode at temperature 1 (30C). Calculated in production test.."]
    #[inline]
    pub fn soc_adc_abs_gain_temp1(&mut self) -> _SOC_ADC_ABS_GAIN_TEMP1W {
        _SOC_ADC_ABS_GAIN_TEMP1W { w: self }
    }
}
