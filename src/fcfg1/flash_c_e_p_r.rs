...
#[doc = r" Proxy"]
pub struct _PV_ACCESSW<'a> {
    w: &'a mut W,
}
impl<'a> _PV_ACCESSW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 255;
...
#[doc = r" Proxy"]
pub struct _A_EXEZ_SETUPW<'a> {
    w: &'a mut W,
}
impl<'a> _A_EXEZ_SETUPW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u8) -> &'a mut W {
        const MASK: u8 = 15;
...
impl W {
    ...
    #[doc = "Bits 24:31 - 31:24\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn rvsu(&mut self) -> _RVSUW {
        _RVSUW { w: self }
    }
    #[doc = "Bits 16:23 - 23:16\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn pv_access(&mut self) -> _PV_ACCESSW {
        _PV_ACCESSW { w: self }
    }
    #[doc = "Bits 12:15 - 15:12\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn a_exez_setup(&mut self) -> _A_EXEZ_SETUPW {
        _A_EXEZ_SETUPW { w: self }
    }
    #[doc = "Bits 0:11 - 11:0\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn cvsu(&mut self) -> _CVSUW {
        _CVSUW { w: self }
    }
}
