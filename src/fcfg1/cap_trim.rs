...
#[doc = r" Proxy"]
pub struct _FLUX_CAP_0P28_TRIMW<'a> {
    w: &'a mut W,
}
impl<'a> _FLUX_CAP_0P28_TRIMW<'a> {
...
#[doc = r" Proxy"]
pub struct _FLUX_CAP_0P4_TRIMW<'a> {
    w: &'a mut W,
}
impl<'a> _FLUX_CAP_0P4_TRIMW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
        const MASK: u16 = 65535;
...
impl W {
    ...
    #[doc = "Bits 16:31 - 31:16\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn flux_cap_0p28_trim(&mut self) -> _FLUX_CAP_0P28_TRIMW {
        _FLUX_CAP_0P28_TRIMW { w: self }
    }
    #[doc = "Bits 0:15 - 15:0\\] Internal. Only to be used through TI provided API."]
    #[inline]
    pub fn flux_cap_0p4_trim(&mut self) -> _FLUX_CAP_0P4_TRIMW {
        _FLUX_CAP_0P4_TRIMW { w: self }
    }
}
