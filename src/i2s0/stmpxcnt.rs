...
#[doc = r" Proxy"]
pub struct _CURR_VALUEW<'a> {
    w: &'a mut W,
}
impl<'a> _CURR_VALUEW<'a> {
    #[doc = r" Writes raw bits to the field"]
    #[inline]
    pub unsafe fn bits(self, value: u16) -> &'a mut W {
        const MASK: u16 = 65535;
...
impl R {
    ...
    #[doc = "Bits 0:15 - 15:0\\] Current value of the XOSC counter, latched when reading STMPWCNT."]
    #[inline]
...
impl W {
    ...
    #[doc = "Bits 0:15 - 15:0\\] Current value of the XOSC counter, latched when reading STMPWCNT."]
    #[inline]
    pub fn curr_value(&mut self) -> _CURR_VALUEW {
        _CURR_VALUEW { w: self }
    }
}
