...
impl R {
    ...
    #[doc = "Bit 5 - 5:5\\] 1: Sets the interrupt of IRQFLAGS.AIF_DMA_IN (unless a auto clear criteria was given at the same time, in which the set will be ignored)"]
    #[inline]
    ...
    #[doc = "Bit 4 - 4:4\\] 1: Sets the interrupt of IRQFLAGS.AIF_DMA_OUT (unless a auto clear criteria was given at the same time, in which the set will be ignored)"]
    #[inline]
    ...
    #[doc = "Bit 3 - 3:3\\] 1: Sets the interrupt of IRQFLAGS.WCLK_TIMEOUT"]
    #[inline]
    ...
    #[doc = "Bit 2 - 2:2\\] 1: Sets the interrupt of IRQFLAGS.BUS_ERR"]
    #[inline]
    ...
    #[doc = "Bit 1 - 1:1\\] 1: Sets the interrupt of IRQFLAGS.WCLK_ERR"]
    #[inline]
    ...
    #[doc = "Bit 0 - 0:0\\] 1: Sets the interrupt of IRQFLAGS.PTR_ERR"]
    #[inline]
